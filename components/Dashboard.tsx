  ...
  return (
    <div className="space-y-6 animate-fade-in pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Main Trend Chart */}
        <div className="lg:col-span-2 bg-slate-900/50 backdrop-blur-md border border-cyan-900/50 p-6 rounded-2xl relative overflow-hidden group">
        ...
        {/* Class Breakdown */}
        <div className="bg-slate-900/50 backdrop-blur-md border border-fuchsia-900/50 p-6 rounded-2xl relative overflow-hidden">
           <h3 className="text-lg font-bold text-white mb-6 flex items-center">
      ...
      <div className="grid grid-cols-1 gap-6">
        {/* Recent List Compact */}
        <div className="bg-slate-900/50 backdrop-blur-md border border-slate-800 p-6 rounded-2xl overflow-hidden">
