...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView }) => {
  ...
  return (
    <aside className="hidden md:flex flex-col w-72 h-screen bg-slate-950/90 border-r border-cyan-900/50 backdrop-blur-xl relative overflow-hidden z-20 shadow-[5px_0_30px_rgba(0,0,0,0.5)]">
